...
Please, implement the method `intersection(Line)` in class [`Line`](src/main/java/com/epam/training/student_Sergei_Bespalov/Line.java).
It  must return a [`Point`](src/main/java/com/epam/training/student_Sergei_Bespalov/Point.java) of intersection of two lines.
...
You may check your result in class [`Main`](src/main/java/com/epam/training/student_Sergei_Bespalov/Main.java).
