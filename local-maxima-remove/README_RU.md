...
Перейдите в класс [LocalMaximaRemove](src/main/java/com/epam/training/student_Sergei_Bespalov/LocalMaximaRemove.java) и реализуйте метод `removeLocalMaxima`.
