...
### Описание
Перейдите в класс [PizzaSplit](src/main/java/com/epam/training/student_Sergei_Bespalov/PizzaSplit.java) и напишите программу, которая должна прочитать два значения из `System.in`:
- количество людей
