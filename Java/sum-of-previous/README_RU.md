...
### Описание
Перейдите в класс [com.epam.training.student_Sergei_Bespalov.SumOfPrevious](src/main/java/com/epam/training/student_Sergei_Bespalov/SumOfPrevious.java) и реализуйте метод `getSumCheckArray`.
