...
### Description
Please, implement the following methods of class [`Segment`](src/main/java/com/epam/training/student_Sergei_Bespalov/Segment.java): 
...
Class [`Point`](src/main/java/com/epam/training/student_Sergei_Bespalov/Point.java) is already there.
