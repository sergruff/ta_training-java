...
An [`Expression`](src/main/java/com/epam/training/student_Sergei_Bespalov/Expression.java) is an interface.
...
the [`Variable`](src/main/java/com/epam/training/student_Sergei_Bespalov/Variable.java) class. 
...
the [`Expressions`](src/main/java/com/epam/training/student_Sergei_Bespalov/Expressions.java) class:
