...
Перейдите к классу  [Snail](/com/epam/training/student_Sergei_Bespalov/Snail.java) и напишите программу с подсчетом количества дней, которые потребуются улитке, чтобы добраться до вершины дерева.
