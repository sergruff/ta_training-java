...
import com.epam.training.student_Sergei_Bespalov.Planes.*;
import com.epam.training.student_Sergei_Bespalov.Planes.PassengerPlane;
import com.epam.training.student_Sergei_Bespalov.models.*;
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Airport passengerAirport = new Airport(airport.getPasengerPlane());
